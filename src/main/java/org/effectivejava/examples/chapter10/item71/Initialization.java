...
public class Initialization {
	...
	// Modern VM will synchronize the access of this field when initializes this class. once this class is initialized, VM will modify and optimize corresponding code, so that subsequent access of this field will not cause any test or synchronization.
