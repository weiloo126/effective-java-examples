...
//		list.set(i, list.set(j, list.get(i))); // won't compile, because mustn't put any type value into List<?> except NULL
		swapHelper(list, i, j);
	}

	// Private helper method for wildcard type capture
